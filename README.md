...
- Grails 3.1.10 (by default; all versions from `2.0.0` up to `3.1.10` can be specified) 
...
The image contains the following customizable Grails related environment variables that can be changed inside the image's Dockerfile.
 ...
 - `GRAILS_VERSION`: Specifies the version of Grails to download (default: `3.1.10`; min: `2.0.0`; max: `3.1.10`).
